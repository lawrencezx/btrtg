# This file is modified from x86/insns.pl
# TODO: delete some unused codes
...
# Create test.h
$oname = "${indir}/test.h";
print STDERR "Creating $oname...\n";
open(A, '>', $oname);

print A "/* This file auto-generated from x86/insns.dat by test/tests.pl" .
    " - don't edit it. */\n\n";
print A "#ifndef NASM_TEST_H\n";
print A "#define NASM_TEST_H\n";
print A "\n";
print A "#define assign_arr5(arr,a0,a1,a2,a3,a4) \\\n";
print A "    { \\\n";
print A "        arr[0] = a0; \\\n";
print A "        arr[1] = a1; \\\n";
print A "        arr[2] = a2; \\\n";
...
# Create insns/test_XXX.c
if (! -d "${indir}/insns") {
    mkdir "${indir}/insns";
}

foreach $i (@opcodes, @opcodes_cc) {
    $oname = "${indir}/insns/test_$i.c";
    print STDERR "Creating $oname...\n";
    open(A, '>', $oname);

    print A "/* This file auto-generated from x86/insns.dat by test/tests.pl" .
        " - you can edit it according to your requirements. */\n\n";
    
    print A "#include \"compiler.h\"\n";
    print A "\n";
    print A "#include \"nasm.h\"\n";
    print A "#include \"insns.h\"\n";
    print A "#include \"generator.h\"\n";
    print A "#include \"test.h\"\n";
    print A "\n";

    print A "static insn_seed ${i}_seed =\n";
    print A "{\n";
    print A "    .opcode = I_${i}\n";
    print A "};\n";
    print A "\n";
    ...
    print A "    generator_exit();\n";
    print A "}\n";

    close A;
}
printf STDERR "Done: %d test files\n", $insns;
